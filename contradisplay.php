...
<th>Narration</th>
  ...
  if($result)
  {
    while ($row =mysqli_fetch_assoc($result))
    {
        ...
        $entriestype = $row['entriestype']; // Corrected variable name
      ...
      <tr>
        ...
        <td><?php echo $entriestype;?></td>
        <td><?php echo $Bankname;?></td>
        <td><?php echo $Accountno;?></td>
        <td><?php echo $amount;?></td>
        <td><?php echo $narration;?></td>
        <td>
          <form action="contradel.php" onsubmit="return confirm('Are you sure to delete?')">
          <input type="hidden" name="id" value="<?php echo $sno?>">
           <button type="submit">Delete</button>
          </form>
    </td>
    <td>
    <form action="updatecontra.php" >
    <input type="hidden" name="id" value="<?php echo $sno?>">
