            ...
            <div class="col-md-12">
                <div class="card mt-4">
                    ...
                    <div class="card-header">
                        <h4>List of the Sales data </h4>
                        <a href="form.php" class="btn btn-primary">Add Sales</a>
                    </div>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                {
                                    $search = $_GET['search'];
                                    $query = "SELECT * FROM customer WHERE CONCAT(invoiceno, Dates, CompanyName, Address) LIKE '%$search%'";
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $items)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $items['saleledger']; ?></td>
                                                <td>
                                                    <form action="delete.php" onsubmit="return confirm('Are you sure to delete?')">
