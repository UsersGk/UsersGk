...
<div class="cont">
        ...
        <div class="syss">
            <h6>Purchase_Invoice</h6>
        </div>    
    </div> 
            
         
    <form action="Purchaseadd.php" method="post">
        <div class="main">
            <div class="main1">
                <input type="text" name="customer" id="customer" placeholder="Customer Name" ><br>
                <textarea id="address" name="address" cols="20" placeholder="Address"></textarea>
                <label for="purchaseledger">Purchase ledger: </label>
                <select name="Purchaseledger">
            ...
            <div class="main2">
                <input type="text" name="invoiceno" id="invoiceno" placeholder="Invoice NO">
        ...
        <table class="table table-striped">
            ...
            <tbody id="net">
                <tr>
                    <td><input type="number" name="slno[]" id="slno" class="sl" value="1"></td>
                    <td><input type="text" name="productName[]" id="productName1"></td>
                    <td><input type="number" name="Qty[]" id="Qty1" onchange="cal(this);" ></td>
                    <td><input type="number" name="Rate[]" id="Rate1" onchange="cal(this);" ></td>
                    <td><input type="number" name="Amt[]" id="Amt1" onchange="cal();"></td>
                    <td> </td>
                </tr>
            </tbody>
        </table>
 ...
 <br>  <label for="netamt"> Net Amt:</label>
        ...
        <textarea rows="4" cols="20" placeholder="Enter Narration Here..." name="narration" id="narration"></textarea><br><br>
